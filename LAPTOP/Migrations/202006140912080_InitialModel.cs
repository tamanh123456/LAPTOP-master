namespace LAPTOP.Migrations
{
    ...
    public partial class InitialModel : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Laptops", "CategoryId", "dbo.Categories");
            DropForeignKey("dbo.Laptops", "AdminId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Laptops", new[] { "CategoryId" });
            DropIndex("dbo.Laptops", new[] { "AdminId" });
